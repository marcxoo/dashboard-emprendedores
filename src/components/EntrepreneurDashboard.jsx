                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium ml-0.5">Gestión de Emprendedores</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/20">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/10 border border-red-100 dark:border-red-900/20 transition-all text-sm font-medium group"
                        >
                            <LogOut size={18} strokeWidth={1.5} className="group-hover:text-red-600 dark:group-hover:text-red-300 transition-colors" />
                            <span>Salir</span>
                        </button>
                    </div>
                </div>
